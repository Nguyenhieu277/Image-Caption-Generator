...
@st.cache_resource
def load_files():
    with open('/home/hieudev/work/image-captioning/trained_model/tokenizer.pkl', 'rb') as f:
        tokenizer = pickle.load(f)
    model = load_model('/home/hieudev/work/image-captioning/trained_model/caption_imgs.keras')
    with open('/home/hieudev/work/image-captioning/trained_model/features.pkl', 'rb') as f:
